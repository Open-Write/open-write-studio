# backend.spec -- PyInstaller build spec for the Open-Write backend.
# ============================================================================
# Run with:
#   uv run pyinstaller backend.spec --clean --noconfirm
# (or use scripts/build-backend.ps1 from the repo root which calls this).
#
# Output: dist/open-write-backend.exe  (a single-file frozen FastAPI server)
#
