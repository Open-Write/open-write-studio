...
# arcs/. Hard-exclude exports/ and .open-write/.
...
_EXCLUDED_PARTS: frozenset[str] = frozenset({"exports", ".open-write"})
...
def _create_snapshot(
    ...
    Layout:
        <project>/.open-write/snapshots/global-replace/<timestamp>/
            manifest.json
    ...
    snap_dir = (
        project_root / ".open-write" / "snapshots" / "global-replace" / timestamp
    )
