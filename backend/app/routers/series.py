...
class CreateSeriesRequest(BaseModel):
    ...
    # the vault root (default ~/Documents/Open-Write) using a slugified
    ...
    if not os.path.exists(series_file):
        raise HTTPException(
            ...
            detail=f"No series.json found in: {folder_path}\n"
                   "This folder doesn't appear to be an Open-Write series."
        )
...
async def create_series(request: CreateSeriesRequest):
    ...
    # vault root (default ~/Documents/Open-Write). Imported inline to keep
