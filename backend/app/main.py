# Open-Write Backend -- Main Entry Point
# ========================================
...
from app.routers import projects, documents, profiles, settings, ai, series, export, progress, search, pipeline, harness, help, names, structure
...
app = FastAPI(
    title="Open-Write API",
    description="Local backend server for the Open-Write writing app.",
    version="0.1.0",
)
...
async def root():
    ...
    return {
        "message": "Open-Write backend is running.",
