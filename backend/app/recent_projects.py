...
#
# Stored in ~/.open-write/open-write.json alongside settings.json.
...
OPEN_WRITE_DIR = Path.home() / ".open-write"
RECENT_FILE     = OPEN_WRITE_DIR / "open-write.json"
...
def track_project(
    ...
    """
    OPEN_WRITE_DIR.mkdir(parents=True, exist_ok=True)
