...
PUNCTUATION_RULE = (
    "PUNCTUATION RULE: "
    "Use em dashes (\u2014) and en dashes (\u2013) sparingly -- no more than "
    "two per page. Prefer commas, periods, colons, semicolons, or parentheses "
    "for most breaks. Em-dash density above ~2/page is flagged by the "
    "naturalism critic and the em_dash lint as an AI-prose tell."
)
...
def build_revise_suggestion_system_prompt(modifier: str, content_mode: str) -> str:
    ...
    parts.append(
        ...
        "- Do not overuse em dashes -- the naturalism critic flags density "
        "above ~2/page. Prefer commas or parentheses for most breaks."
    )
