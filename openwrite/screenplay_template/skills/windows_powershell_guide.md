# Windows PowerShell Guide — Screenplay Production

*Windows PowerShell commands and patterns for screenplay production work. Use this guide when working on Windows PowerShell instead of Unix/bash.*
...
```powershell
Get-Content -Path 'script/screenplay.fountain' -Encoding UTF8
Get-Content -Path 'script/screenplay.fountain' -Head 10 -Encoding UTF8
Get-Content -Path 'script/screenplay.fountain' -Tail 10 -Encoding UTF8
(Get-Content -Path 'script/screenplay.fountain' -Encoding UTF8).Count
```
