...
Usage:
    python tools/page_count.py                          # Count assembled screenplay.fountain
...
def main():
    ...
    if filepath:
        ...
        # Default: count assembled script
        ...
        if os.path.exists(assembled):
            ...
            if os.path.exists(scene_dir):
                ...
                print("No script found. Run assemble.py first or pass a file path.")
                sys.exit(1)
