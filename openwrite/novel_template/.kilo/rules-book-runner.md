...
```powershell
# Reader A — qualitative cold coverage
...
# Reader B — qualitative cold coverage
python tools/reader_dispatch.py `
    --manuscript manuscript/novel.md `
    --rules-file .kilo/rules-adversarial-reader.md `
...
- `coverage_reports/adversarial_reader_A.md` — Reader A output (qualitative), with `<!-- DISPATCH PROVENANCE -->` header
- `coverage_reports/adversarial_reader_B.md` — Reader B output (qualitative), with `<!-- DISPATCH PROVENANCE -->` header
