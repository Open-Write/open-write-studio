# WSL/Git Bash Setup Guide — Novel Production

*Using Windows Subsystem for Linux or Git Bash for novel production work.*
...
3. Access your project from WSL
   ```bash
   wsl
   cd /mnt/c/path/to/your/novel/project
   ```
...
| C:\path\to\project\manuscript | /mnt/c/path/to/project/manuscript |
...
alias proj-manuscript='cd /mnt/c/path/to/your/project/manuscript'
```
...
python3 prose_audit.py
python3 callback_check.py
python3 convention_scan.py
python3 assemble.py --title "Title" --author "Author"
python3 export_formats.py
```
...
*This guide is specific to novel production. Adapt paths for your project location.*
