# THE RED BERET — Section VII: Prose Discipline
...
**The failure:** AI prose defaults toward summary. *Martín spent the morning cleaning his rifle* is not a scene. It tells the reader that time passed without rendering any of it.
...
- **Extreme close-up:** The eye's movement, the breath catching, the specific weight of a hand on a shoulder, the grit under a fingernail.
- **Middle distance:** The default for most scene work.
- **Compressed lyric distance:** A season passing in two sentences. A campaign in a paragraph.
...
**The failure:** Generic interiority is worse than no interiority. *Martín felt sad* is worse than nothing.
...
|-------|---------|---------|
| Named emotion | *Martín felt grief.* | Bad. Cut or replace. |
| Named emotion with qualifier | *Martín felt a familiar grief.* | Still bad. |
| Physical symptom | *His chest tightened.* | Better, but generic. |
| Specific physical detail | *He set the crucifix down harder than he meant to.* | Good. Behavioral, specific. |
| Rendered consciousness | *The dining table had not changed since the morning his father stopped speaking about the king.* | Best. Interiority as perception. |
...
- **Dialogue differentiation is mandatory.** Each character must sound distinct. Martín's Carlist register is not Tomás's Navarrese dialect. Salazar's Castilian precision is not Padre Joaquín's pastoral warmth. Vidal's military clippedness is not Amaia's teacher's clarity.

---

### IX. THE POV CONTRACT

Each chapter is Martín's POV. The prose stays inside his perception, knowledge, and voice for the chapter's duration.

- **Close third** (default): The narrator knows what Martín knows. What Martín cannot see, the prose cannot describe.
- **Free indirect** (specific moments): Martín's voice bleeds into the narration. "The beret was heavy. Not the wool. The rest of it."
- **No omniscient.** The narrator does not have access to other characters' interiority. Don Eusebio's silence is rendered through what Martín sees: the face, the hands, the window. Padre Joaquín's doubt is rendered through what Martín hears: the shorter homilies, the pauses, the unfinished sentences.
