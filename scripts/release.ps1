# scripts/release.ps1 -- Cut an Open-Write release
# ============================================================================
...
# may be "Open-Write_1.0.1_x64_en-US.msi" but the live URL serves
# it as "Open-Write.Studio_1.0.1_x64_en-US.msi". URL-encoding the space
# as %20 also fails -- GitHub doesn't decode it back, and a 404 results.
# So we rewrite spaces to dots here for the manifest URL.
$repo = "open-write/open-write"
...
Write-Host "         --title `"Open-Write v$Version`" \``"
