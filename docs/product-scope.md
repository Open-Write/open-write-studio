...
**Open-Write** is a Windows desktop, local-first Markdown writing application for fiction and worldbuilding. The writer drafts the prose; AI provides context-aware review, refinement, summarization, and brainstorming on demand.
