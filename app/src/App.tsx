...
// ======================================
// This is the top-level component of Open-Write's frontend.
//
...
function App() {
  ...
  const [currentView, setCurrentView]   = useState<
    "editor" | "profiles" | "notes" | "chapter_summary" | "scene_summary" | "outline_planner" | "pipeline"
  >("editor");
  ...
  const writingCompanionPanel = useRightPanelWidth("open-write.writingCompanion.width");
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <p className="text-xs text-red-100">
          ...
          Open-Write can't reach the local API at <span className="font-mono">localhost:8000</span>.
          Start it with{" "}
      ...
      <aside className="relative flex w-64 shrink-0 flex-col border-r border-border bg-bg-panel">
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-4">
          ...
          <NavSection label="Production">
            <NavItem label="Pipeline" hint="Autonomous Open-Write pipeline (bible to finalize)"
        ...
        <div className="border-t border-border px-4 py-3">
          ...
          <button
            ...
            title="About Open-Write: version, license, donations"
          >
            <span>ℹ About</span>
