// components/Wordmark.tsx -- Open-Write Dashboard Wordmark
// =================================================================
// Renders the official Open-Write logo as a wide banner across
// the top of the ProjectHome dashboard.
//
// Asset: app/public/openwrite.png
//   Vite serves anything in app/public/ at the site root, so this loads as
//   /openwrite.png. Replace that file to swap the artwork; no code
//   change needed.
//
// About the layout:
//   The logo is a wide horizontal mark (cursive "Open-Write" + Studio +
