    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          {update.notes ? (
            ...
            <p className="text-sm text-text-muted">
              ...
              <button
                onClick={() => openLink("https://github.com/open-write/open-write/blob/main/CHANGELOG.md")}
        ...
        <div className="flex shrink-0 items-center justify-between border-t border-border bg-bg-primary px-5 py-3">
          <button
            onClick={() => openLink(`https://github.com/open-write/open-write/releases/tag/v${update.version}`)}
