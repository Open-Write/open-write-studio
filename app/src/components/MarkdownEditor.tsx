...
// --- Open-Write Color Themes (dark + light) ---
...
const openWriteDarkTheme = createTheme({
  theme: "dark",
  settings: {
...
const openWriteLightTheme = createTheme({
  theme: "light",
  settings: {
...
export function MarkdownEditor({ defaultValue, onChange, font, onEditorReady, onSelectionChange }: MarkdownEditorProps) {
  ...
  const editorTheme   = appTheme === "light" ? openWriteLightTheme : openWriteDarkTheme;
